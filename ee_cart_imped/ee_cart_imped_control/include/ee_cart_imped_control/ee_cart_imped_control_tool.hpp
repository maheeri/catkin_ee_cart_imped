#ifndef __EE_CART_IMPED_CONTROL_TOOL_HPP__
#define __EE_CART_IMPED_CONTROL_TOOL_HPP__
...
// If defined, will transmit out the applied wrench at a rate of 
// 1kHz/WRENCH_PD on WRENCH_TOPIC
#define SEND_WRENCH
#define WRENCH_TOPIC "wrenchApplied"
#define WRENCH_PD 25
...
//You probably shouldn't get anywhere close to this limit either,
//it's just set high to make sure you don't run into it. 2500 is
//about as high as you should go!
...
namespace ee_cart_imped_control_ns {
   ...
   */
  class EECartImpedControlClassTool: public pr2_controller_interface::Controller {
  private:
